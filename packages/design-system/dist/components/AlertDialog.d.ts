...
export declare const StyledContent: import("@stitches/react/types/styled-component").StyledComponent<React.ForwardRefExoticComponent<AlertDialogPrimitive.AlertDialogContentProps & React.RefAttributes<HTMLDivElement>>, {}, {
    bp1: "(min-width: 520px)";
    bp2: "(min-width: 900px)";
...
declare type AlertDialogContentPrimitiveProps = React.ComponentProps<typeof StyledContent>;
declare type AlertDialogContentProps = AlertDialogContentPrimitiveProps & {
    css?: CSS;
};
